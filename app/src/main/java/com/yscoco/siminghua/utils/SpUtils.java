...
public class SpUtils {
    ...
    public static <T> void setData(String key, T data) {
        ...
        String dataJson = JsonUtils.serialize(data);
        SpUtils.putString(MyApplication.getApplication(), key, dataJson);
    }

    public static <T> T getData(String key, Class<T> cls) {

        String dataStr = SpUtils.getString(MyApplication.getApplication(), key, null);
        if (null == dataStr) {
            return null;
        }

        T deserialize = JsonUtils.deserialize(dataStr, cls);
        return deserialize;
    }
    ...
    public static <T> void setDataList(String key, List<T> datalist) {
        ...
        SpUtils.putString(MyApplication.getApplication(), key, strJson);
    }
    ...
    public static <T> List<T> getDataList(String key, Class<T> cls) {
        ...
        String strJson = SpUtils.getString(MyApplication.getApplication(), key, null);
