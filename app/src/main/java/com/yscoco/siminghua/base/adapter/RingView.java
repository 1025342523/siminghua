...
/**
 * @author Created by lishihui on 2018/8/10.
 */
...
public class RingView extends View {
    ...
    private int circleCenterX = 80;     // 圆心点X  要与外圆半径相等
    private int circleCenterY = 80;     // 圆心点Y  要与外圆半径相等

    private int ringOuterRidus = 80;     // 外圆的半径
...
//        int height = wm.getDefaultDisplay().getHeight();
        ...
        mPaint.setColor(getResources().getColor(R.color.black_one_color));
    ...
    private void drawCenterPoint(Canvas canvas) {
        mPaint.setColor(mRes.getColor(R.color.black_two_color));
//        Log.e("中心点:", dip2px(circleCenterX + mPaintWidth * 2 + leftMargin) + " --- " + dip2px(circleCenterY + mPaintWidth * 2 + topMargin));
        canvas.drawCircle(dip2px(circleCenterX + mPaintWidth * 2 + leftMargin),
                dip2px(circleCenterY + mPaintWidth * 2 + topMargin), dip2px(1), mPaint);
    }
...
//        Log.e("内部圆点:", dip2px(circleCenterX + mPaintWidth * 2 + leftMargin) + " --- " + dip2px(circleCenterY + mPaintWidth * 2 + topMargin));
        canvas.drawCircle(dip2px(circleCenterX + mPaintWidth * 2 + leftMargin),
                dip2px(circleCenterY + mPaintWidth * 2 + topMargin), dip2px(ringInnerRidus), mPaint);
    }
    ...
    private void drawArcCenterPoint(Canvas canvas, int position) {
        ...
        mPaint.setColor(mRes.getColor(R.color.color_transparent));//设置内环线透明
        ...
        mPaint.setColor(mRes.getColor(R.color.color_transparent));//设置指示线端小圆圈魏透明
